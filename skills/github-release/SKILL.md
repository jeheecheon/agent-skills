---
name: github-release
description: Create a GitHub release for an existing tag, matching the repository's existing release conventions. Use when the user wants release notes drafted or a release published.
---
