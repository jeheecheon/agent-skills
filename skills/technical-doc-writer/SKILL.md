...
description: Generate a technical document for an LLM agent reader with zero prior knowledge, using strict numbering, deduplication, and concise but exhaustive explanations. Use when the user wants rigorous technical documentation on a topic.
---
