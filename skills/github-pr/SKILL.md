---
name: github-pr
description: Create a GitHub pull request for the current branch, following branch naming and PR conventions from the repository. Use when the user wants a PR drafted or opened.
---
