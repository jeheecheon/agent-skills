---
name: github-issue
description: Create a GitHub issue from user input or current branch changes, matching the repository's existing issue conventions. Use when the user wants an issue drafted or opened.
---
