---
name: git-commit
description: Create a git commit for staged changes, split by feature unit and following repository conventions. Use when the user wants a clean commit created from already staged files.
---
